...
static const char batch_size_message[] = "Number of inputs in once inference (default 1)";

static const char show_result_message[] = "Output data format first 10(0) or top ten(1) (default first 10(0))";

static const char csv_message[] = "Save result into csv file";

static const char write_brief_message[] = "Wirte brief into csv";
...
/// @brief Show result (default 1)
DEFINE_int32(sr, 0, show_result_message);

/// @brief Save result (default 0)
DEFINE_string(csv, "", csv_message);

/// @brief Write brief (default 0)
DEFINE_string(wr, "", write_brief_message);
...
static void showUsage() {
    ...
    std::cout << "    -sr \"<integer>\"         " << show_result_message << std::endl;
    std::cout << "    -csv \"<path>\"         " << csv_message << std::endl;
    std::cout << "    -wr \"<string>\"         " << write_brief_message << std::endl;
}
